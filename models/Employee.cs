...
namespace HR
{
    public class Employee
    {
         ...
         */
        public static int create(string SSN, string FirstName, string middleInitial, string lastName, DateTime dob, string gender, string phone, Job job, Address address) {
        ...
        public Department OwnDepartment
        {

    ...
    public partial class EmployeeCreate : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            // Getting the employee Information
                ...
                string gender = GenderDropDown.SelectedItem.Value.ToString();
                ...
                string contract = ContractTypeDropDown.SelectedItem.Value;
                int workingHours = int.Parse(WorkingHoursDropDown.SelectedItem.Value);
                bool workingStatus = (WorkingStatusDropDown.SelectedItem.Value == "Working");

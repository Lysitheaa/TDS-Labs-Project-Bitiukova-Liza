...
namespace HR_SYSTEM.views
{
    public partial class Employees : System.Web.UI.Page
    {
        ...
        protected void fillUnApprovedEmployees(ArrayList employees = null) {
            // Creating a row
            TableRow row = new TableRow();
            ...
            foreach (Employee e in employees)
            {
                ...
                viewvalue.Text = @"<a class='btn btn-info btn-small' href=EmployeeView.aspx?id=" + e.Id + ">View</a>" + "<a class='btn btn-warning btn-small' href=EmployeeView.aspx?id=" + e.Id + ">Edit</a>";

...
<body>
    ...
    <div>
		...
		<tr>
			<td>Name: </td>
            <td>
                <asp:TextBox ID="nameTextBox" runat="server" BorderColor="Red" required="required"></asp:TextBox>
            </td>
		</tr>
		...
		<tr>
            ...
            <td>
                ...
                <asp:FileUpload ID="FileUpload1" runat="server" BorderColor="Red" required="required"/>

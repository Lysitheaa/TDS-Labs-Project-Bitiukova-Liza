    ...
    <uc1:header ID="header1" runat="server" />
     <div class="container">
        ...
        <tr>
            <td>Name: </td>
            <td>
                <asp:TextBox ID="TextBox1" runat="server" BorderColor="Red" required="required"></asp:TextBox>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:DropDownList ID="DropDownList1" runat="server" BorderColor="Red" required="required">
                </asp:DropDownList>
